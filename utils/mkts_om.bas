...
Dim Shared As uByte nametable (767)
...
Dim Shared As Integer globalPalette (31), HWPalette (31)
...
Sub doPals (img As Any Ptr, prefix As String, outputFn As String)
	...
	Select Case platform
		Case PLATFORM_CPC:
			...
			Print #f, "// Generated by mkts_om v0.1.20170904"
...
Sub doChars (img As Any Ptr, xc0 As Integer, yc0 As Integer, w As Integer, h As Integer, max As Integer)
	...
	Puts "mkts_om v0.1.20170904 ~ Chars mode, " & ct & " patterns extracted (" & (ct * patternSize) & " bytes)."
End Sub
...
Sub cpcDoNametable (img As Any Ptr)
	...
	Puts "mkts_om v0.1.20170904 ~ Nametable mode, " & ct & " patterns extracted (" & (ct * patternSize) & " bytes)."
End Sub
...
Sub cpcDoSuperBuffer (img As Any Ptr)
	...
	Puts "mkts_om v0.1.20170904 ~ Superbuffer mode (12288 bytes)."
End Sub
...
Sub cpcDoScr (img As Any Ptr)
	...
	Puts "mkts_om v0.1.20170904 ~ Superbuffer mode (16384 bytes)."
	Puts "HW Palette for the BASIC loader: "
	textpal = ""
	For i = 0 To 15
...
Sub doTmaps (img As Any Ptr, xc0 As Integer, yc0 As Integer, w As Integer, h As Integer, wMeta As Integer, hMeta As Integer, max As Integer)
	...
	Puts "mkts_om v0.1.20170904 ~ Tmaps mode, " & ct & " patterns extracted (" & (ct * patternSize) & " bytes) from " & ctTmaps & " metatiles (" & (ctTmaps * i * wMeta * hMeta) & " bytes)."
End Sub
...
Sub zxDoSprites (img As Any Ptr, xc0 As Integer, yc0 As Integer, w As Integer, h As Integer, wMeta As Integer, hMeta As Integer, max As Integer)
	...
	Puts "mkts_om v0.1.20170904 ~ Sprites mode, " & ct & " " & wMetaPixels & "x" & hMetaPixels & " sprite cells with masks extracted (" & (mainIndex) & " bytes)."
End Sub
...
Sub cpcDoSprites (img As Any Ptr, xc0 As Integer, yc0 As Integer, w As Integer, h As Integer, wMeta As Integer, hMeta As Integer, max As Integer)
	...
	Puts "mkts_om v0.1.20170904 ~ Sprites mode, " & ct & " " & wMetaPixels & "x" & hMetaPixels & " sprite cells extracted (" & (mainIndex - curIndex) & " bytes)."
End Sub
...
Sub zxDoBg (img As Any Ptr, xc0 As Integer, yc0 As Integer, w As Integer, h As Integer)
	...
	Puts "mkts_om v0.1.20170904 ~ BG mode, " & ct & " patterns (" & (8*ct) & " bytes). NT is " & auxIndex & " bytes."
End Sub
